...
export default function BountyBriefClient({
  ...
  return (
    <main className="w-full min-h-[calc(100dvh-44px)] md:min-h-[calc(100dvh-60px)] lg:min-h-[calc(100dvh-100px)] bg-[var(--page-bg)] text-page flex items-center justify-center px-5 sm:px-8 py-10 sm:py-14">
