...
/**
 * Home cine promo — The Bureaux under bounties.
  ...
  return (
    <section className="w-full px-8 md:px-16 mt-8 md:mt-10 mb-4 md:mb-8">
      <div className="w-full max-w-[1440px] mx-auto">
        <Link
          href="/bureaux"
          className="group relative block w-full overflow-hidden rounded-[8px] aspect-[3/4] md:aspect-[2.39/1] bg-[#1B2838] text-white"
        >
