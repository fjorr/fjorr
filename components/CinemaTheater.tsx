    ...
    >
      {isRamsChrome ? (
        <button
          ...
          className={`absolute top-[max(1rem,env(safe-area-inset-top))] left-[max(1rem,env(safe-area-inset-left))] z-50 bg-transparent border-0 p-0 outline-none cursor-pointer transition-all duration-500 ease-out ${
            controlsVisible
        ...
        >
          <svg
            viewBox="0 0 143 81"
            className="w-[36px] h-auto text-[#F5F5F7]"
            fill="currentColor"
