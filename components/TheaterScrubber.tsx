...
/**
 * Horizontal timeline — quiet hairline + yellow bead playhead.
 * Time floats above the bead while scrubbing (stays clear of the cursor).
 *
 * Snapshot kept in TheaterScrubberClassic.tsx. Switch chrome via
 * `THEATER_PLAYER_CHROME` in lib/theater/player-chrome-variant.ts.
 */
