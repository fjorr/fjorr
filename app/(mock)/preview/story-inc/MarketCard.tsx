    ...
    >
      ...
      <div className="p-5">
        <div className="flex items-center justify-between gap-2 text-[12px] text-[#6e6e73]">
          <span className="font-semibold">Angry Birds 3</span>
        ...
        <div className="mt-4 flex gap-2">
          {top.map((o) => (
            <button
              ...
              type="button"
              onMouseEnter={() => setHover(o.label)}
              className="flex-1 rounded-full bg-white py-2 text-[12px] font-bold text-[#1d1d1f] ring-1 ring-black/10 transition-colors hover:bg-[#00a6ff] hover:text-white hover:ring-[#00a6ff]"
            >
              {o.label}
            </button>
          ))}
