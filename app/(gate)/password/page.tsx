  ...
  return (
    <div className="w-full min-h-screen bg-dark-01 flex flex-col items-center justify-center px-6 text-white font-sans selection:bg-white selection:text-black">
      <div className="w-full max-w-xs flex flex-col items-center text-center">
        ...
        <div className="mb-10 w-32 h-auto text-white flex items-center justify-center">
          <svg width="143" height="81" viewBox="0 0 143 81" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-auto">
