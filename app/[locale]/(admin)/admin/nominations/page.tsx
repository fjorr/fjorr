  ...
  return (
    <div className="flex flex-col gap-10 max-w-4xl">
      ...
      {nominations.length === 0 ? (
        <p className="font-sans text-[14px] text-white/40">Inbox empty.</p>
      ) : (
          ...
          {nominations.map((n) => (
            ...
            >
              <div className="flex flex-col gap-3 min-w-0">
                ...
                <p className="font-sans text-[15px] font-semibold text-white/90 leading-relaxed whitespace-pre-wrap">
                  {n.story_details}
                </p>

                <dl className="flex flex-col gap-2.5 text-left">
                  <div>
                    <dt className="font-sans text-[11px] font-semibold uppercase tracking-wide text-white/30">
                      Why Fjorr
                    </dt>
                    <dd className="font-sans text-[13px] text-white/55 leading-snug mt-0.5">
                      {n.why_fjorr}
                    </dd>
                  </div>
                  <div>
